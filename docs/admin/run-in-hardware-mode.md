...
From sgxwallet 1.10.4, `getServerOptions` reports the options the wallet runs with, including whether ZMQ key ownership (`-e`) is enforced (`effective.zmqKeyOwnershipEnforced`):

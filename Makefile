...
pkgdatadir = $(datadir)/sgx-gmp-test
pkgincludedir = $(includedir)/sgx-gmp-test
pkglibdir = $(libdir)/sgx-gmp-test
pkglibexecdir = $(libexecdir)/sgx-gmp-test
...
am__v_CCLD_1 = 
SOURCES = $(sgxd_SOURCES) $(nodist_sgxd_SOURCES)
DIST_SOURCES = $(sgxd_SOURCES)
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"SGX\ GMP\ Test\" -DPACKAGE_TARNAME=\"sgx-gmp-test\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"SGX\ GMP\ Test\ 1.0\" -DPACKAGE_BUGREPORT=\"john.p.mechalas@intel.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"sgx-gmp-test\" -DVERSION=\"1.0\" -DDEBUG=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
EXEEXT = 
GMP_CPPFLAGS = -I/d/sgxd/gmp_build/include
GMP_LDFLAGS = -L/d/sgxd/gmp_build/lib
...
PACKAGE_NAME = SGX GMP Test
PACKAGE_STRING = SGX GMP Test 1.0
PACKAGE_TARNAME = sgx-gmp-test
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
SHELL = /bin/bash
STRIP = 
TGMP_CPPFLAGS = -I/d/sgxd/gmp_build/include
TGMP_LDFLAGS = -L/d/sgxd/gmp_build/lib
VERSION = 1.0
abs_builddir = /d/sgxd
abs_srcdir = /d/sgxd

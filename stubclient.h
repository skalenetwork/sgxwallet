...
class StubClient : public jsonrpc::Client
{
    public:
        ...
        Json::Value importBLSKeyShare(const std::string& keyShare, const std::string& keyShareName) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["keyShare"] = keyShare;
        ...
        Json::Value blsSignMessageHash(const std::string& keyShareName, const std::string& messageHash, int t, int n) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["keyShareName"] = keyShareName;
        ...
        Json::Value generateDKGPolyV3(const std::string& polyName, const std::string& previousBLSPrivateKeyName, int t) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["polyName"] = polyName;
        ...
        Json::Value getVerificationVector(const std::string& polyName, int t) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["polyName"] = polyName;
            p["t"] = t;
        ...
        Json::Value getSecretShareV2(const std::string& polyName, const Json::Value& publicKeys, int t, int n) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["n"] = n;
            p["polyName"] = polyName;
        ...
        Json::Value dkgVerificationV2(const std::string& publicShares, const std::string& ethKeyName, const std::string& secretShare, int t, int n, int index) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["ethKeyName"] = ethKeyName;
            p["index"] = index;
        ...
        Json::Value createBLSPrivateKeyV2(const std::string& blsKeyName, const std::string& ethKeyName, const std::string& polyName, const std::string& secretShare, int t, int n) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["blsKeyName"] = blsKeyName;
            p["ethKeyName"] = ethKeyName;
        ...
        Json::Value createBLSPrivateKeyV3(const std::string& blsKeyName, const std::string& ethKeyName, const std::string& polyName, const Json::Value& secretContributions, int t, int n) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["blsKeyName"] = blsKeyName;
            p["ethKeyName"] = ethKeyName;
        ...
        Json::Value complaintResponse(const std::string& polyName, int t, int n, int ind) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["ind"] = ind;
            p["n"] = n;
        ...
        Json::Value calculateAllBLSPublicKeys(const Json::Value& publicShares, int t, int n) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["n"] = n;
            p["publicShares"] = publicShares;
        ...
        Json::Value getServerVersion() throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
        ...
        Json::Value deleteBlsKey(const std::string& blsKeyName) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["blsKeyName"] = blsKeyName;
        ...
        Json::Value getDecryptionShares(const std::string& blsKeyName, const Json::Value& publicDecryptionValues) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["blsKeyName"] = blsKeyName;
            p["publicDecryptionValues"] = publicDecryptionValues;
        ...
        Json::Value popProve(const std::string& blsKeyName) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["blsKeyName"] = blsKeyName;
        ...
        Json::Value generateBLSPrivateKey(const std::string& blsKeyName) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["blsKeyName"] = blsKeyName;
        ...
        Json::Value getAllKeysInfo() throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p = Json::nullValue;
        ...
        Json::Value getLatestCreatedKey() throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p = Json::nullValue;
        ...
        Json::Value getServerConfiguration() throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p = Json::nullValue;
        ...
        Json::Value isKeyExist(const std::string& key) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["keyName"] = key;

...
skale::ostream& operator<<(skale::ostream &out, const edwards_Fq_conic_coefficients &cc)
{
    out << cc.c_ZZ << OUTPUT_SEPARATOR << cc.c_XY << OUTPUT_SEPARATOR << cc.c_XZ;
    return out;
}

skale::istream& operator>>(skale::istream &in, edwards_Fq_conic_coefficients &cc)
{
    in >> cc.c_ZZ;
...
skale::ostream& operator<<(skale::ostream &out, const edwards_tate_G2_precomp &prec_Q)
{
    out << prec_Q.y0 << OUTPUT_SEPARATOR << prec_Q.eta;
    return out;
}

skale::istream& operator>>(skale::istream &in, edwards_tate_G2_precomp &prec_Q)
{
    in >> prec_Q.y0;
    consume_OUTPUT_SEPARATOR(in);
    in >> prec_Q.eta;
...
skale::ostream& operator<<(skale::ostream &out, const edwards_Fq3_conic_coefficients &cc)
{
    out << cc.c_ZZ << OUTPUT_SEPARATOR << cc.c_XY << OUTPUT_SEPARATOR << cc.c_XZ;
    return out;
}

skale::istream& operator>>(skale::istream &in, edwards_Fq3_conic_coefficients &cc)
{
    in >> cc.c_ZZ;
    consume_OUTPUT_SEPARATOR(in);
    in >> cc.c_XY;
...
skale::ostream& operator<<(skale::ostream &out, const edwards_ate_G1_precomp &prec_P)
{
...
skale::istream& operator>>(skale::istream &in, edwards_ate_G1_precomp &prec_P)
{

...
class mnt6_G2;
skale::ostream& operator<<(skale::ostream &, const mnt6_G2&);
skale::istream& operator>>(skale::istream &, mnt6_G2&);
...
public:
    ...
    friend skale::ostream& operator<<(skale::ostream &out, const mnt6_G2 &g);
    friend skale::istream& operator>>(skale::istream &in, mnt6_G2 &g);

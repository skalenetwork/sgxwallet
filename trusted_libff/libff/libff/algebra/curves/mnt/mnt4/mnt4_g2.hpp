...
class mnt4_G2;
skale::ostream& operator<<(skale::ostream &, const mnt4_G2&);
skale::istream& operator>>(skale::istream &, mnt4_G2&);
...
public:
    ...
    friend skale::ostream& operator<<(skale::ostream &out, const mnt4_G2 &g);
    friend skale::istream& operator>>(skale::istream &in, mnt4_G2 &g);

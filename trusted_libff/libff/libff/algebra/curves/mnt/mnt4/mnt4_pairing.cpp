...
skale::ostream& operator<<(skale::ostream &out, const mnt4_ate_G1_precomp &prec_P)
{
...
skale::istream& operator>>(skale::istream &in, mnt4_ate_G1_precomp &prec_P)
{
    in >> prec_P.PX;
...
skale::ostream& operator<<(skale::ostream &out, const mnt4_ate_dbl_coeffs &dc)
{
    out << dc.c_H << OUTPUT_SEPARATOR << dc.c_4C << OUTPUT_SEPARATOR << dc.c_J << OUTPUT_SEPARATOR << dc.c_L;
    return out;
}

skale::istream& operator>>(skale::istream &in, mnt4_ate_dbl_coeffs &dc)
{
    in >> dc.c_H;
    consume_OUTPUT_SEPARATOR(in);
    in >> dc.c_4C;
...
skale::ostream& operator<<(skale::ostream &out, const mnt4_ate_add_coeffs &ac)
{
    out << ac.c_L1 << OUTPUT_SEPARATOR << ac.c_RZ;
    return out;
}

skale::istream& operator>>(skale::istream &in, mnt4_ate_add_coeffs &ac)
{
    in >> ac.c_L1;
    consume_OUTPUT_SEPARATOR(in);
    in >> ac.c_RZ;
...
skale::ostream& operator<<(skale::ostream& out, const mnt4_ate_G2_precomp &prec_Q)
{
...
skale::istream& operator>>(skale::istream& in, mnt4_ate_G2_precomp &prec_Q)
{
    in >> prec_Q.QX;
    consume_OUTPUT_SEPARATOR(in);
    in >> prec_Q.QY;

...
class AbstractStubServer : public jsonrpc::AbstractServer<AbstractStubServer>
{
    public:
        AbstractStubServer(jsonrpc::AbstractServerConnector &conn, jsonrpc::serverVersion_t type = jsonrpc::JSONRPC_SERVER_V2) : jsonrpc::AbstractServer<AbstractStubServer>(conn, type)
        {
            ...
            this->bindAndAddMethod(jsonrpc::Procedure("blsSignMessageHash", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "keyShareName",jsonrpc::JSON_STRING,"messageHash",jsonrpc::JSON_STRING,"n",jsonrpc::JSON_INTEGER,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::blsSignMessageHashI);
            ...
            this->bindAndAddMethod(jsonrpc::Procedure("generateDKGPolyV3", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "polyName",jsonrpc::JSON_STRING,"previousBLSPrivateKeyName",jsonrpc::JSON_STRING,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::generateDKGPolyV3I);
            ...
            this->bindAndAddMethod(jsonrpc::Procedure("getSecretShare", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "n",jsonrpc::JSON_INTEGER,"polyName",jsonrpc::JSON_STRING,"publicKeys",jsonrpc::JSON_ARRAY,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::getSecretShareI);
            this->bindAndAddMethod(jsonrpc::Procedure("getSecretShareV2", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "n",jsonrpc::JSON_INTEGER,"polyName",jsonrpc::JSON_STRING,"publicKeys",jsonrpc::JSON_ARRAY,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::getSecretShareV2I);
            this->bindAndAddMethod(jsonrpc::Procedure("dkgVerification", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "ethKeyName",jsonrpc::JSON_STRING,"index",jsonrpc::JSON_INTEGER,"n",jsonrpc::JSON_INTEGER,"publicShares",jsonrpc::JSON_STRING,"secretShare",jsonrpc::JSON_STRING,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::dkgVerificationI);
            this->bindAndAddMethod(jsonrpc::Procedure("dkgVerificationV2", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "ethKeyName",jsonrpc::JSON_STRING,"index",jsonrpc::JSON_INTEGER,"n",jsonrpc::JSON_INTEGER,"publicShares",jsonrpc::JSON_STRING,"secretShare",jsonrpc::JSON_STRING,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::dkgVerificationV2I);
            this->bindAndAddMethod(jsonrpc::Procedure("createBLSPrivateKey", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "blsKeyName",jsonrpc::JSON_STRING,"ethKeyName",jsonrpc::JSON_STRING,"n",jsonrpc::JSON_INTEGER,"polyName",jsonrpc::JSON_STRING,"secretShare",jsonrpc::JSON_STRING,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::createBLSPrivateKeyI);
            this->bindAndAddMethod(jsonrpc::Procedure("createBLSPrivateKeyV2", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "blsKeyName",jsonrpc::JSON_STRING,"ethKeyName",jsonrpc::JSON_STRING,"n",jsonrpc::JSON_INTEGER,"polyName",jsonrpc::JSON_STRING,"secretShare",jsonrpc::JSON_STRING,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::createBLSPrivateKeyV2I);
            this->bindAndAddMethod(jsonrpc::Procedure("createBLSPrivateKeyV3", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "blsKeyName",jsonrpc::JSON_STRING,"ethKeyName",jsonrpc::JSON_STRING,"n",jsonrpc::JSON_INTEGER,"polyName",jsonrpc::JSON_STRING,"secretContributions",jsonrpc::JSON_ARRAY,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::createBLSPrivateKeyV3I);
            ...
            this->bindAndAddMethod(jsonrpc::Procedure("complaintResponse", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "ind",jsonrpc::JSON_INTEGER,"n",jsonrpc::JSON_INTEGER,"polyName",jsonrpc::JSON_STRING,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::complaintResponseI);
            ...
            this->bindAndAddMethod(jsonrpc::Procedure("calculateAllBLSPublicKeys", jsonrpc::PARAMS_BY_NAME, jsonrpc::JSON_OBJECT, "n",jsonrpc::JSON_INTEGER,"publicShares",jsonrpc::JSON_ARRAY,"t",jsonrpc::JSON_INTEGER, NULL), &AbstractStubServer::calculateAllBLSPublicKeysI);
        ...
        inline virtual void generateDKGPolyV3I(const Json::Value &request, Json::Value &response)
        {
            response = this->generateDKGPolyV3(request["polyName"].asString(), request["previousBLSPrivateKeyName"].asString(), request["t"].asInt());
        }
        ...
        inline virtual void createBLSPrivateKeyV3I(const Json::Value &request, Json::Value &response)
        {
            response = this->createBLSPrivateKeyV3(request["blsKeyName"].asString(), request["ethKeyName"].asString(), request["polyName"].asString(), request["secretContributions"], request["t"].asInt(), request["n"].asInt());
        }
        ...
        virtual Json::Value generateDKGPolyV3(const std::string& polyName, const std::string& previousBLSPrivateKeyName, int t) = 0;
        ...
        virtual Json::Value createBLSPrivateKeyV3(const std::string& blsKeyName, const std::string& ethKeyName, const std::string& polyName, const Json::Value& secretContributions, int t, int n) = 0;
        ...
        virtual Json::Value getDecryptionShares(const std::string& blsKeyName, const Json::Value& publicDecryptionValues) = 0;

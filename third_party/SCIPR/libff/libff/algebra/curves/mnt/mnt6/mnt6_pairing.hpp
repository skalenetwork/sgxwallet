...
struct mnt6_ate_G1_precomp {
    ...
    friend skale::ostream& operator<<(skale::ostream &out, const mnt6_ate_G1_precomp &prec_P);
    friend skale::istream& operator>>(skale::istream &in, mnt6_ate_G1_precomp &prec_P);
};
...
struct mnt6_ate_dbl_coeffs {
    ...
    friend skale::ostream& operator<<(skale::ostream &out, const mnt6_ate_dbl_coeffs &dc);
    friend skale::istream& operator>>(skale::istream &in, mnt6_ate_dbl_coeffs &dc);
};
...
struct mnt6_ate_add_coeffs {
    ...
    friend skale::ostream& operator<<(skale::ostream &out, const mnt6_ate_add_coeffs &dc);
    friend skale::istream& operator>>(skale::istream &in, mnt6_ate_add_coeffs &dc);
};
...
struct mnt6_ate_G2_precomp {
    ...
    friend skale::ostream& operator<<(skale::ostream &out, const mnt6_ate_G2_precomp &prec_Q);
    friend skale::istream& operator>>(skale::istream &in, mnt6_ate_G2_precomp &prec_Q);
};

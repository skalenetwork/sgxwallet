...
template<mp_size_t n, const bigint<n>& modulus>
skale::ostream& operator<<(skale::ostream &, const Fp_model<n, modulus>&);

template<mp_size_t n, const bigint<n>& modulus>
skale::istream& operator>>(skale::istream &, Fp_model<n, modulus> &);
...
public:
    ...
    friend skale::ostream& operator<< <n,modulus>(skale::ostream &out, const Fp_model<n, modulus> &p);
    friend skale::istream& operator>> <n,modulus>(skale::istream &in, Fp_model<n, modulus> &p);
};

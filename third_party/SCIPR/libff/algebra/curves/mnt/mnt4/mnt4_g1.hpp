...
class mnt4_G1;
skale::ostream& operator<<(skale::ostream &, const mnt4_G1&);
skale::istream& operator>>(skale::istream &, mnt4_G1&);
...
public:
    ...
    friend skale::ostream& operator<<(skale::ostream &out, const mnt4_G1 &g);
    friend skale::istream& operator>>(skale::istream &in, mnt4_G1 &g);
...
skale::ostream& operator<<(skale::ostream& out, const std::vector<mnt4_G1> &v);
skale::istream& operator>>(skale::istream& in, std::vector<mnt4_G1> &v);

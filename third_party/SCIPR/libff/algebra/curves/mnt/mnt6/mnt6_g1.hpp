...
class mnt6_G1;
skale::ostream& operator<<(skale::ostream &, const mnt6_G1&);
skale::istream& operator>>(skale::istream &, mnt6_G1&);
...
public:
    ...
    friend skale::ostream& operator<<(skale::ostream &out, const mnt6_G1 &g);
    friend skale::istream& operator>>(skale::istream &in, mnt6_G1 &g);
...
skale::ostream& operator<<(skale::ostream& out, const std::vector<mnt6_G1> &v);
skale::istream& operator>>(skale::istream& in, std::vector<mnt6_G1> &v);

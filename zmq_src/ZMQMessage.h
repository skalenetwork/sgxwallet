...
class ZMQMessage {
  ...
  static cache::lru_cache<string, pair<shared_ptr<EVP_PKEY>, shared_ptr<X509>>> verifiedCerts;
...
public:
  ...
  static constexpr const char *GET_DECRYPTION_SHARE_REQ =
      "getDecryptionShareReq";
  static constexpr const char *GET_DECRYPTION_SHARE_RSP =
      "getDecryptionShareRsp";
  static constexpr const char *GENERATE_BLS_PRIVATE_KEY_REQ =
      "generateBLSPrivateKeyReq";
  static constexpr const char *GENERATE_BLS_PRIVATE_KEY_RSP =
      "generateBLSPrivateKeyRsp";
  static constexpr const char *POP_PROVE_REQ = "popProveReq";
  static constexpr const char *POP_PROVE_RSP = "popProveRsp";
  ...
  enum Requests {
    ...
    ENUM_GENERATE_BLS_PRIVATE_KEY_REQ,
    ENUM_POP_PROVE_REQ
  };
  enum Responses {
    ENUM_BLS_SIGN_RSP,
    ...
    ENUM_GENERATE_BLS_PRIVATE_KEY_RSP,
    ENUM_POP_PROVE_RSP
  };
  ...
  static shared_ptr<ZMQMessage> buildRequest(string &type,
                                             shared_ptr<rapidjson::Document> _d,
                                             bool _checkKeyOwnership);
  static shared_ptr<ZMQMessage>
  buildResponse(string &type, shared_ptr<rapidjson::Document> _d,
                bool _checkKeyOwnership);
